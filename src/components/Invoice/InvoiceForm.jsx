        ...
        <form className="w-full flex-col bg-white rounded px-6 py-4 mt-4">
          ...
          <div className="flex flex-wrap qs-bold -mx-3 mb-2">
            ...
            <div className="w-full md:w-1/2 px-3">
              ...
              <input className="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 leading-tight focus:outline-none focus:bg-gray focus:border-transparent" id="tot-amount" type="text" placeholder="NGN 48,375"/>
            </div>
          </div>
        </form>
